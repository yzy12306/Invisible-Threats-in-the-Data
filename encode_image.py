...
def main():
    ...
    parser.add_argument('--model', type=str,default='ckpt/encoder_imagenet')
    parser.add_argument('--image', type=str, default=None)
    parser.add_argument('--images_dir', type=str, default='/home/wayne/PycharmProjects/project/data/org')
    parser.add_argument('--save_dir', type=str, default='/home/wayne/PycharmProjects/project/data/bd')
